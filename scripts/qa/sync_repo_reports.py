...
- `iaa_summary.json` / `iaa_summary.md`: pairwise agreement summary for human annotators and Gemini automatic annotation
- `iaa_visualization_report.json`: metadata for the IAA figures
- `iaa_kappa_heatmap_matrix.png`: pairwise kappa heatmap for Annotator 1, Annotator 2, and Gemini annotation
...
- Evaluation artifacts include pairwise agreement outputs for human annotators and Gemini automatic annotation.
"""
    dst.parent.mkdir(parents=True, exist_ok=True)
