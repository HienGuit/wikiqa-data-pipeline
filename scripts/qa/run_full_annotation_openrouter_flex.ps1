param(
    ...
    [string]$OutputDir = "data/processed/runs/qa/annotation_openrouter_gemini3_flash_flex",
    [string]$MergedOutput = "data/processed/archive/qa/annotation_exports/qa_annotation_openrouter_gemini3_flash_flex.jsonl",
    [string]$RejectOutput = "data/processed/archive/qa/annotation_exports/qa_annotation_openrouter_gemini3_flash_flex_rejects.jsonl",
    [string]$SummaryOutput = "data/processed/reports/qa/qa_annotation_openrouter_gemini3_flash_flex_summary.json",
...
$manifest = [ordered]@{
    mode = "full_annotation_openrouter_flex"
...
for ($worker = 0; $worker -lt $Workers; $worker++) {
    $workerId = $worker
    $job = Start-Job -Name "annotation-worker-$workerId" -ArgumentList @(
        $repoRoot,
        $inputFullPath,
        $outputFullPath,
        $logDir,
