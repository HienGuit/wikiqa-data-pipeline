...
- Judge-diagnostic dataset: `8,005` QA pairs from `qa_pairs_canonical_judged_context_cleaned.jsonl`.
...
- Multi-sentence QA has a markedly higher weak-quality share than extraction in the full judged pool (11.6% vs 2.4%), supporting the decision to apply stricter human verification to inferential content.
...
- `culture` shows the highest weak-quality proportion in the full judged pool and should therefore be discussed explicitly in the limitations section.
